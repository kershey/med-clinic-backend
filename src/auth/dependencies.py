...
def verify_account_status(status: AccountStatus, allowed_statuses: List[AccountStatus]) -> bool:
    """
    Verify if a user's account status is allowed.
    
    Args:
        status: User's account status
        allowed_statuses: List of allowed account statuses
